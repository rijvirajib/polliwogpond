...
function PickerConstructor( ELEMENT, NAME, COMPONENT, OPTIONS ) {
        ...
        P = PickerInstance.prototype = {
            ...
            open: function( dontGiveFocus ) {
                ...
                if ( dontGiveFocus !== false ) {
                    ...
                    $document.on( 'touchstart.' + STATE.id + ' click.' + STATE.id + ' focusin.' + STATE.id, function( event ) {
                    ...
                    }).on( 'touchstart.' + STATE.id + ' keydown.' + STATE.id, function( event ) {
    ...
    function prepareElement() {
        ...
        $ELEMENT.
            ...
            on('touchstart.' + STATE.id + ' focus.' + STATE.id + ' click.' + STATE.id, focusToOpen)
        ...
        if ( !SETTINGS.editable ) {
            ...
            $ELEMENT.on('touchstart.' + STATE.id + ' keydown.' + STATE.id, function(event) {
    ...
    function prepareElementRoot() {
        ...
        P.$root.
            ...
            on({
                ...
                'mousedown click touchstart': function( event ) {
            ...
            on( 'click touchstart', '[data-pick], [data-nav], [data-clear]', function() {
